...
pub async fn close_position(
    ...
    let lp_token_mint_pda = pda::get_lp_token_mint_pda(&position_account.pool).0;
    ...
    let srt_custody_pda = pda::get_custody_pda(
        &position_account.pool,
        &lm_staking_account.reward_token_mint,
    )
    .0;
    let srt_custody_token_account_pda = pda::get_custody_token_account_pda(
        &position_account.pool,
        &lm_staking_account.reward_token_mint,
    )
    .0;
