    ...
    // See impact of opening a new position
    {
        ...
        // Double check effect of opening position on ETH/USDC custody accounting
        {
            ...
            // Distributed rewards
            {
                ...
                // USDC
                {
                    let before = &usdc_custody_account_before.distributed_rewards;
                    let after = &usdc_custody_account_after.distributed_rewards;

                    assert_eq!(before.open_position_lm + 15_000, after.open_position_lm);
        ...
        // Double check effect of closing position on ETH custody accounting
        {
            ...
            // Distributed rewards
            {
                ...
                // USDC
                {
                    ...
                    assert_eq!(before.close_position_lm + 14_850, after.close_position_lm);
                    assert_unchanged!(before.open_position_lm, after.open_position_lm);
                    assert_unchanged!(before.swap_lm, after.swap_lm);
                    assert_unchanged!(before.add_liquidity_lm, after.add_liquidity_lm);
                    assert_unchanged!(before.remove_liquidity_lm, after.remove_liquidity_lm);
            ...
            // Trade Stats
            {
                // ETH
                {
                    ...
                    assert_eq!(before.oi_short_usd - 1_485_000_000, after.oi_short_usd);
                    assert_eq!(before.profit_usd + 106_650_000, after.profit_usd);
                }
